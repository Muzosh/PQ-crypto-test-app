...
class Ui_MainWindow(object):
    ...
    def updateRequestedKeyLengthLabel(self):
        ...
        if selected_key != "" and keyType != "":
            ...
            self.key_requested_length_label.setText("Requested length: " + str(self.requestedLength))
        else:
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.key_upload_key_button.sizePolicy().hasHeightForWidth())
        ...
        self.key_upload_key_button.setStyleSheet(u"QPushButton {\n"
"	border: 2px solid rgb(52, 59, 72);\n"
"border-radius: 15px;	\n"
"	background-color: rgb(52, 59, 72);\n"
"}\n"
...
"")
        ...
        self.about_title.setStyleSheet(u"background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        ...
        sizePolicy7.setHeightForWidth(self.about_label.sizePolicy().hasHeightForWidth())
        ...
        self.about_table_frame.setObjectName(u"about_table_frame")
        self.about_table_frame.setGeometry(QRect(10, 70, 880, 291))
        self.about_table_frame.setStyleSheet(u"background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        ...
        self.about_table_layout.setObjectName(u"about_table_layout")
        ...
        self.about_table.setObjectName(u"about_table")
        sizePolicy13 = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.MinimumExpanding)
        sizePolicy13.setHorizontalStretch(0)
        sizePolicy13.setVerticalStretch(0)
        sizePolicy13.setHeightForWidth(self.about_table.sizePolicy().hasHeightForWidth())
        ...
        self.about_table.setStyleSheet(u"QTableWidget {	\n"
"	background-color: rgb(39, 44, 54);\n"
"	padding: 10px;\n"
"	border-radius: 5px;\n"
"	gridline-color: rgb(44, 49, 60);\n"
...
"")
        ...
        self.about_table.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContents)
        ...
        self.about_table.horizontalHeader().setProperty("showSortIndicator", False)
        ...
        self.about_info_layout.setObjectName(u"about_info_layout")
        self.about_info_layout.setContentsMargins(0, 0, 0, 0)
        self.about_info_box_label = QLabel(self.verticalLayoutWidget_10)
        self.about_info_box_label.setObjectName(u"about_info_box_label")
        sizePolicy6.setHeightForWidth(self.about_info_box_label.sizePolicy().hasHeightForWidth())
        ...
        self.about_info_sec1_label.setObjectName(u"about_info_sec1_label")
        self.about_info_sec1_label.setFont(font15)
        self.about_info_sec1_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.about_info_sec2_label.setObjectName(u"about_info_sec2_label")
        self.about_info_sec2_label.setFont(font15)
        self.about_info_sec2_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.about_info_sec3_label.setObjectName(u"about_info_sec3_label")
        self.about_info_sec3_label.setFont(font15)
        self.about_info_sec3_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.about_info_sec4_label.setObjectName(u"about_info_sec4_label")
        self.about_info_sec4_label.setFont(font15)
        self.about_info_sec4_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.about_info_sec5_label.setObjectName(u"about_info_sec5_label")
        self.about_info_sec5_label.setFont(font15)
        self.about_info_sec5_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.about_latency_frame.setObjectName(u"about_latency_frame")
        self.about_latency_frame.setGeometry(QRect(9, 369, 881, 221))
        self.about_latency_frame.setStyleSheet(u"background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        ...
        self.about_latency_title_label.setObjectName(u"about_latency_title_label")
        self.about_latency_title_label.setGeometry(QRect(0, 0, 870, 50))
        sizePolicy7.setHeightForWidth(self.about_latency_title_label.sizePolicy().hasHeightForWidth())
        ...
        self.about_latency_layout.setObjectName(u"about_latency_layout")
        self.about_latency_layout.setContentsMargins(0, 0, 0, 0)
        self.about_latency_text_KEM_label = QLabel(self.verticalLayoutWidget_3)
        self.about_latency_text_KEM_label.setObjectName(u"about_latency_text_KEM_label")
        ...
        self.about_latency_text_DSA_label.setObjectName(u"about_latency_text_DSA_label")
        ...
        self.about_latency_text_note_label.setObjectName(u"about_latency_text_note_label")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.key_checkbox4.setText(QCoreApplication.translate("MainWindow", u"KEM - NTRU-HPS", None))
        ...
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow", u"NTRU-HPS (encrypt)", None));
        ...
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"NTRU-HPS (decrypt)", None));
        ...
        ___qtablewidgetitem32.setText(QCoreApplication.translate("MainWindow", u"Rainbow Vc (sign)", None));
        ...
        ___qtablewidgetitem35.setText(QCoreApplication.translate("MainWindow", u"Rainbow Vc (verify)", None));
        ...
        ___qtablewidgetitem47.setText(QCoreApplication.translate("MainWindow", u"KEM - NTRU-HPS", None));
        ...
        ___qtablewidgetitem49.setText(QCoreApplication.translate("MainWindow", u"DSA - Rainbow Vc", None));
        ...
        self.about_label.setText(QCoreApplication.translate("MainWindow", u"About cryptanalysis of post-quantum algorithms", None))
        ___qtablewidgetitem51 = self.about_table.horizontalHeaderItem(0)
        ___qtablewidgetitem51.setText(QCoreApplication.translate("MainWindow", u"Type", None));
        ...
        ___qtablewidgetitem55.setText(QCoreApplication.translate("MainWindow", u"KEM - Kyber", None));
        ___qtablewidgetitem56 = self.about_table.verticalHeaderItem(2)
        ___qtablewidgetitem56.setText(QCoreApplication.translate("MainWindow", u"KEM - SABER", None));
        ___qtablewidgetitem57 = self.about_table.verticalHeaderItem(3)
        ___qtablewidgetitem57.setText(QCoreApplication.translate("MainWindow", u"KEM - NTRU-HPS", None));
        ___qtablewidgetitem58 = self.about_table.verticalHeaderItem(4)
        ___qtablewidgetitem58.setText(QCoreApplication.translate("MainWindow", u"DSA - Dilithium", None));
        ___qtablewidgetitem59 = self.about_table.verticalHeaderItem(5)
        ___qtablewidgetitem59.setText(QCoreApplication.translate("MainWindow", u"DSA - Rainbow Vc", None));
        ___qtablewidgetitem60 = self.about_table.verticalHeaderItem(6)
        ___qtablewidgetitem60.setText(QCoreApplication.translate("MainWindow", u"DSA - SPHINCS", None));

        __sortingEnabled3 = self.about_table.isSortingEnabled()
        self.about_table.setSortingEnabled(False)
        ___qtablewidgetitem61 = self.about_table.item(0, 0)
        ___qtablewidgetitem61.setText(QCoreApplication.translate("MainWindow", u"Code", None));
        ...
        ___qtablewidgetitem63.setText(QCoreApplication.translate("MainWindow", u"1 357 824", None));
        ___qtablewidgetitem64 = self.about_table.item(1, 0)
        ___qtablewidgetitem64.setText(QCoreApplication.translate("MainWindow", u"Lattice", None));
        ...
        ___qtablewidgetitem66.setText(QCoreApplication.translate("MainWindow", u"1 568", None));
        ___qtablewidgetitem67 = self.about_table.item(2, 0)
        ___qtablewidgetitem67.setText(QCoreApplication.translate("MainWindow", u"Lattice", None));
        ___qtablewidgetitem68 = self.about_table.item(2, 1)
        ___qtablewidgetitem68.setText(QCoreApplication.translate("MainWindow", u"3", None));
        ___qtablewidgetitem69 = self.about_table.item(2, 2)
        ___qtablewidgetitem69.setText(QCoreApplication.translate("MainWindow", u"992", None));
        ...
        ___qtablewidgetitem73.setText(QCoreApplication.translate("MainWindow", u"Lattice", None));
        ...
        ___qtablewidgetitem75.setText(QCoreApplication.translate("MainWindow", u"1760", None));
        ...
        ___qtablewidgetitem79.setText(QCoreApplication.translate("MainWindow", u"Hash", None));
        ...
        ___qtablewidgetitem81.setText(QCoreApplication.translate("MainWindow", u"64", None));
        self.about_table.setSortingEnabled(__sortingEnabled3)

        self.about_info_box_label.setText(QCoreApplication.translate("MainWindow", u"Security Level Categories (NIST)", None))
        self.about_info_sec1_label.setText(QCoreApplication.translate("MainWindow", u"1 - equivalent to AES-128 key search", None))
        self.about_info_sec2_label.setText(QCoreApplication.translate("MainWindow", u"2  - equivalent to SHA-256/SHA3-256 collision search", None))
        self.about_info_sec3_label.setText(QCoreApplication.translate("MainWindow", u"3 - equivalent to AES-192 key search", None))
        self.about_info_sec4_label.setText(QCoreApplication.translate("MainWindow", u"4 - equvalent to SHA-384/SHA3-384 collision search", None))
        self.about_info_sec5_label.setText(QCoreApplication.translate("MainWindow", u"5 - equivalent to AES-256 key search", None))
        self.about_latency_title_label.setText(QCoreApplication.translate("MainWindow", u"Latency Overview", None))
        self.about_latency_text_KEM_label.setText(QCoreApplication.translate("MainWindow", u"According to our measurements and public research for KEM the best performance usually has Crystals-Kyber, followed by NTRU-HPS, SABER and finally McEliece.", None))
        self.about_latency_text_DSA_label.setText(QCoreApplication.translate("MainWindow", u"For DSA algorithms the best performance has Crystals-Dilithium followed by SPHINCS and Rainbow Vc (the latency of Rainbow Vc is really high due to lenght of keys).", None))
        self.about_latency_text_note_label.setText(QCoreApplication.translate("MainWindow", u"*** The latency and overall performance is directly related to the hardware of machine.", None))
        ...
        ___qtablewidgetitem83.setText(QCoreApplication.translate("MainWindow", u"1", None));
        ...
        ___qtablewidgetitem85.setText(QCoreApplication.translate("MainWindow", u"3", None));
        ...
        ___qtablewidgetitem102.setText(QCoreApplication.translate("MainWindow", u"Test", None));
        ___qtablewidgetitem103 = self.tableWidget.item(0, 1)
        ___qtablewidgetitem103.setText(QCoreApplication.translate("MainWindow", u"Text", None));
        ___qtablewidgetitem104 = self.tableWidget.item(0, 2)
        ___qtablewidgetitem104.setText(QCoreApplication.translate("MainWindow", u"Cell", None));
        ___qtablewidgetitem105 = self.tableWidget.item(0, 3)
        ___qtablewidgetitem105.setText(QCoreApplication.translate("MainWindow", u"Line", None));
    ...
    # retranslateUi
        ...
        keys = [self.key_checkbox1, self.key_checkbox2, self.key_checkbox3, self.key_checkbox4, self.key_checkbox4_2,
                self.key_checkbox4_3, self.key_checkbox4_4, self.key_private_radio_button, self.key_public_radio_button]
